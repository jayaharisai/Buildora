        ...
        <div className='main_session_a'>
          <div className='main_session_a_container'>
            ...
            <div className='main_session_a_login'>
              <div>
                <div className='dora_title'>Welcome Back</div>
                <div className='dora_description'>Enter your email and password to access your account</div>
              </div>
              ...
              <div className='dora_text'>Don't have an account? <span><Link className='link' to="/register">Register Now</Link></span></div>
            </div>
